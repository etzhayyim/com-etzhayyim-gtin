...
(defn collection
  [name]
  (str "com.etzhayyim.gtin." name))

(def cell-specs {
  :lookupproduct {:legacy-cell "com-etzhayyim-gtin-lookupProduct"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "lookupproduct")]
     :required-gates common-gates
     :trigger "manifest cell lookupproduct"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :product {:legacy-cell "com-etzhayyim-gtin-product"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :alias {:legacy-cell "com-etzhayyim-gtin-alias"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "alias")]
     :required-gates common-gates
     :trigger "manifest cell alias"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :brand {:legacy-cell "com-etzhayyim-gtin-brand"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "brand")]
     :required-gates common-gates
     :trigger "manifest cell brand"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :category {:legacy-cell "com-etzhayyim-gtin-category"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "category")]
     :required-gates common-gates
     :trigger "manifest cell category"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
